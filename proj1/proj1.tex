...
\usepackage[text={17cm,23cm}, left=2cm, top=2cm]{geometry}
...
\begin{quotation}
{\fontfamily{qag} \selectfont{Čím více druhů,}} {\textsc{řezů}}, {\tiny{velikostí}}, ~barev ~  pís\-ma {\underline{a jiných efektů}} použijeme, tím {\large{\emph{profesionálněji}}} bude dokument vypadat. Čtenář tím bude vždy \textsc{nadšen}!
\end{quotation}
